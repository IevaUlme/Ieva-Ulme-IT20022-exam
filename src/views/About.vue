...
<template>
    ...
    <div class="wrapper-header">
        <h1>ABOUT ME</h1>
        <div class="settings">
            <button id="btn-edit" v-bind:class="[{ active : editingForm }]" @click="toggleEdit()" v-text="btnText()"></button>
            <button id="btn-save" v-show="editingForm" @click="toggleEdit(), saveInput()">Save Form</button>
        </div>
    </div>
    <form>
